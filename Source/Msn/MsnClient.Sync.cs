//-----------------------------------------------------------------------
// <copyright file="MsnClient.Sync.cs" company="The Outercurve Foundation">
...
namespace Msn
{
    ...
    {
        /// <summary>
        /// Makes a request to the Msn server.
        /// </summary>
        ...
        /// <summary>
        /// Makes a GET request to the Msn server.
        /// </summary>
        /// <param name="path">The resource path or the resource url.</param>
        /// <returns>The json result.</returns>
        ...
        /// <summary>
        /// Makes a POST request to the Msn server.
        /// </summary>
        /// <param name="parameters">The parameters.</param>
        /// <returns>The json result.</returns>
        ...
        /// <summary>
        /// Makes a DELETE request to the Msn server.
        /// </summary>
        /// <param name="path">The resource path or the resource url.</param>
        /// <returns>The json result.</returns>
