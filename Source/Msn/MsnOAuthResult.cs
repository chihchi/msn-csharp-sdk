//-----------------------------------------------------------------------
// <copyright file="MsnOAuthResult.cs" company="The Outercurve Foundation">
...
namespace Msn
{
    ...
    /// <summary>
    /// Represents the authentication result of Msn.
    /// </summary>
    public class MsnOAuthResult
    {
        /// <summary>
        /// The access token.
        /// </summary>
        ...
        /// <summary>
        /// Error Code that happens when using OAuth2 protocol.
        /// </summary>
        private readonly long _error_code;

        /// <summary>
        /// Initializes a new instance of the <see cref="MsnOAuthResult"/> class.
        /// </summary>
        protected MsnOAuthResult()
        {
        }
        ...
        /// </remarks>
        internal MsnOAuthResult(IDictionary<string, object> parameters)
        {
            if (parameters == null)
            ...
            if (parameters.ContainsKey("error_code"))
            {
                _error_code = long.Parse(parameters["error_code"].ToString());
            }
        }
        ...
        /// </summary>
        /// <remarks>
        /// https://developers.msn.com/docs/oauth/errors/
        /// </remarks>
        ...
        /// <summary>
        /// Gets the code used to exchange with Msn to retrieve access token.
        /// </summary>
