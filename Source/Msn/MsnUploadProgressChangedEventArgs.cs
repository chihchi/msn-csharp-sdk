//-----------------------------------------------------------------------
// <copyright file="MsnUploadProgressChangedEventArgs.cs" company="The Outercurve Foundation">
...
namespace Msn
{
    ...
    /// <summary>
    /// Represents Msn api upload progress changed event args.
    /// </summary>
    public class MsnUploadProgressChangedEventArgs : ProgressChangedEventArgs
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MsnUploadProgressChangedEventArgs"/> class.
        /// </summary>
        ...
        public MsnUploadProgressChangedEventArgs(long bytesReceived, long totalBytesToReceive, long bytesSent, long totalBytesToSend, int progressPercentage, object userToken)
