//-----------------------------------------------------------------------
// <copyright file="MsnMediaStream.cs" company="The Outercurve Foundation">
...
namespace Msn
{
    ...
    public class MsnMediaStream : IDisposable
    {
        /// <summary>
        ...
        /// <returns>Msn Media Stream</returns>
        public MsnMediaStream SetValue(Stream value)
        {
            _value = value;
            return this;
        }
