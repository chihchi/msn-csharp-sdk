//-----------------------------------------------------------------------
// <copyright file="MsnMediaObject.cs" company="The Outercurve Foundation">
...
namespace Msn
{
    ...
    public class MsnMediaObject
    {
        ...
        /// <returns>Msn Media Object</returns>
        public MsnMediaObject SetValue(byte[] value)
        {
            _value = value;
            return this;
        }
